...
from .ascend_config import WeightPrefetchConfig, get_ascend_config
...
def enable_sp(vllm_config=None, enable_shared_expert_dp: bool = False) -> bool:
    ...
    if _ENABLE_SP is None:
        ...
        _ENABLE_SP = (
            ...
            or VLLM_ASCEND_ENABLE_FLASHCOMM1
...
def flashcomm2_enable() -> bool:
    return VLLM_ASCEND_FLASHCOMM2_PARALLEL_SIZE > 0
...
def get_flashcomm2_config_and_validate(ascend_config, vllm_config):
    flashcomm2_oproj_tp_size = VLLM_ASCEND_FLASHCOMM2_PARALLEL_SIZE
    ...
    if not VLLM_ASCEND_ENABLE_FLASHCOMM1:
        logger.warning_once(
